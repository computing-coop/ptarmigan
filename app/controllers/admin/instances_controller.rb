class Admin::InstancesController < Admin::BaseController
  ...
  def update
    ...
    if @instance.update_attributes(instance_params)
      ...
      logger.warn @instance.errors.full_messages
    end
  end
  ...
  def instance_params
    params.require(:instance).permit([:start_at, :end_at, :ticket_url, :specialimage, :place_id, :title, :event_id, :price, :discounted_price, :remove_specialimage, :slug, translations_attributes:[:id, :locale, :special_information, :notes, :_delete]])
  end
