...
class Project < ActiveRecord::Base
  ...
  has_attached_file :carousel, :styles => {:new_carousel => "960x400#", :full => "600x400#", :small => "300x200#"}, :path =>  ":rails_root/public/images/carousel/projects/:id/:style/:basename.:extension",
