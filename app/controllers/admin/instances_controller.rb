class Admin::InstancesController < Admin::BaseController
  ...
  def instance_params
    params.require(:instance).permit([:start_at, :end_at, :ticket_url, :specialimage, :title, :event_id, :remove_specialimage, translations_attributes:[:id, :locale, :special_information, :_delete]])
  end
